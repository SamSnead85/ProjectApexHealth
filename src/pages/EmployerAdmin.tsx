...
import './Enrollment.css'  // Use Enrollment's premium CSS

// ============================================
// MOCK DATA - Employer Benefits Administration
// ============================================
...
const employees = [
    { id: 'EMP-001', name: 'Sarah Johnson', initials: 'SJ', department: 'Engineering', status: 'active', plan: 'PPO Gold', planTier: 'Family', cost: 524 },
    { id: 'EMP-002', name: 'Michael Chen', initials: 'MC', department: 'Marketing', status: 'active', plan: 'HDHP', planTier: 'Employee+Spouse', cost: 389 },
    { id: 'EMP-003', name: 'Emily Rodriguez', initials: 'ER', department: 'Sales', status: 'pending', plan: 'PPO Silver', planTier: 'Employee', cost: 245 },
    { id: 'EMP-004', name: 'James Wilson', initials: 'JW', department: 'Finance', status: 'active', plan: 'PPO Gold', planTier: 'Employee+Child', cost: 412 },
    { id: 'EMP-005', name: 'Lisa Thompson', initials: 'LT', department: 'HR', status: 'cobra', plan: 'PPO Gold', planTier: 'Family', cost: 524 },
    { id: 'EMP-006', name: 'David Kim', initials: 'DK', department: 'Engineering', status: 'active', plan: 'HDHP', planTier: 'Employee', cost: 198 },
]

const benefitPlans = [
    { name: 'PPO Gold', enrolled: 285, percent: 58.5, color: '#f59e0b', cost: '$100K/mo' },
    { name: 'HDHP with HSA', enrolled: 156, percent: 32.0, color: '#10b981', cost: '$43K/mo' },
    { name: 'Delta Dental PPO', enrolled: 412, percent: 84.6, color: '#6366f1', cost: '$16K/mo' },
    { name: 'VSP Vision', enrolled: 389, percent: 79.9, color: '#8b5cf6', cost: '$6K/mo' },
    { name: 'Basic Life & AD&D', enrolled: 487, percent: 100, color: '#06b6d4', cost: '$8K/mo' },
]

const timelineEvents = [
    { event: 'Open Enrollment Period Begins', date: '2024-02-01', status: 'upcoming' },
    { event: 'New Hire: Sarah Williams', date: '2024-02-03', status: 'upcoming' },
    { event: 'COBRA Termination: John Miller', date: '2024-01-20', status: 'complete' },
    { event: 'Plan Renewal Review', date: '2024-01-15', status: 'complete' },
]

const aiInsights = [
    { text: 'Based on utilization patterns, recommend promoting **HDHP with HSA** to reduce employer costs by ~12%', confidence: 91 },
    { text: '**3 employees** approaching 30-day enrollment deadline. Auto-reminders scheduled.', confidence: 98 },
    { text: 'Dental plan renewal in 28 days. Current rates **3.2% below market** - recommend early lock-in.', confidence: 87 },
]
...
export function EmployerAdmin() {
    ...
    const totalEmployerCost = benefitPlans.reduce((sum, plan) => {
        const costNum = parseInt(plan.cost.replace(/[$K\/mo,]/g, '')) * 1000
        return sum + costNum
    }, 0)
                                    ...
                                    <td>
                                        <div className="benefits-admin__roster-employee">
                                            <div
                                                ...
                                                style={{ background: `hsl(${i * 50 + 180}, 65%, 45%)` }}
                                            >
                                                {emp.initials}
                                            </div>
